...
fun PlacesListScreen(
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        Row(
            ...
            Row {
                IconButton(onClick = { selectedView = ViewType.LIST }) {
                    Icon(
                ...
                IconButton(onClick = { selectedView = ViewType.GRID }) {
                    Icon(
        ...
        when (uiState) {
            ...
            is UiState.Success -> {
                val places = (uiState as UiState.Success<List<Place>>).data.sortedByDescending { it.createdAt }
                when (selectedView) {
